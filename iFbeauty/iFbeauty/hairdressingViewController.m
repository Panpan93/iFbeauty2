...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    hairdressingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"hairdressingCell"];
...
- (void)loadDataBegin {
    ...
    if (loadingMore == NO) /**没有在加载**/{
        ...
        [self.hairdressingTV.tableFooterView addSubview:_tableFooterAI];
...
- (void)beforeLoadEnd {
    UILabel *label = (UILabel *)[self.hairdressingTV.tableFooterView viewWithTag:9001];
...
- (void)loadDataEnd {
    self.hairdressingTV.tableFooterView = [[UIView alloc] init];
    loadingMore = NO;
    
}

- (void)createTableFooter {
    UIView *tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.hairdressingTV.bounds.size.width, 40.0f)];
    ...
    self.hairdressingTV.tableFooterView = tableFooterView;
}
