...
@interface collectdeleteViewController ()


@end

@implementation collectdeleteViewController
...
- (void)viewDidLoad {
    ...
    _deLabel.text =[NSString stringWithFormat:@"%@", activity[@"detail"]];
